...
/// <summary>
/// Log subscription handle for <see cref="SqlServerEventStore"/> (poll-backed live).
/// Yields frames; the typed adapter hydrates.
/// </summary>
internal sealed class SqlServerSubscriptionHandle : IEventLogSubscriptionHandle
{

...
{
    /// <summary>Shipped default payload content type (STJ UTF-8 JSON).</summary>
    ...
    /// <summary>Payload codec identifier stored with the frame.</summary>
    ...
    /// <param name="contentType">Payload content type. Default <see cref="DefaultContentType"/>.</param>

...
| Tests | Unit tests cover the new code. SQL integration tests use `Category=Integration`. The InMemory → SQL swap and event-log contract use `Category=Contract` (SQL legs also `Integration`) |

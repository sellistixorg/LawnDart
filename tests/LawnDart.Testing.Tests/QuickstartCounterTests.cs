...
namespace LawnDart.Testing.Tests;

/// <summary>
/// Compiles and asserts the README / QUICKSTART Counter. Excerpt those
/// pages from this file — do not invent a third shape.
/// </summary>
public sealed class QuickstartCounterTests
{
    [Fact]
    public async Task handle_command_then_read_back_is_one()
    {
        ...
        Assert.Equal(1, loaded!.State.Value);
    }
}
